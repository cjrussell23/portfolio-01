    ...
    <>
      ...
      <main className="flex flex-col items-center justify-start w-full bg-background -mt-[100px]">
        ...
        >
          ...
          <p className="mb-4">
            Welcome to my corner of the web - very much a work in progress. I'm
            Charles, a software developer based in Calgary, Alberta. I'm
            passionate about all things tech and enjoy building innovative
            solutions that solve real-world problems. I'm a firm believer in the
            power of technology to transform lives and make the world a better
            place. I'm also a strong advocate for sectionersity and inclusion in
            the tech industry.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            experience by managing and developing the company's website. It's a
            role that challenges me daily and allows me to contribute to the
            digital presence of a cutting-edge organization.
          </p>
          <p className="mb-4">
