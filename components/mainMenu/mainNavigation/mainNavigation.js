...
export default function MainNavigation({ menuItems }) {
  ...
  return (
    <nav className="tw-flex tw-h-full tw-max-h-60vh tw-w-full tw-flex-col tw-gap-6 tw-overflow-y-auto tw-px-4 tw-py-2 md:tw-max-h-full md:tw-overflow-y-visible">
